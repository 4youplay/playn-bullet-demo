...
/**
 * This is not a complete emulation of GL11 -- it only covers the aspects needed for porting
 * Quake.
 * 
 * @author Stefan Haustein
 */
public final class GL11FixedFunctionEmulation implements GL11 {
  ...
  private FloatBuffer texMatrixBuffer = Buffers.allocateNativeFloatBuffer(2 * 16);
  private IntBuffer enableTexBuffer = Buffers.allocateNativeIntBuffer(2);
  private FloatBuffer matrixBuffer = Buffers.allocateNativeFloatBuffer(16);
  private IntBuffer tmpIntBuffer = Buffers.allocateNativeIntBuffer(16);
  ...
  public GL11FixedFunctionEmulation(GL20 gl) {
    this.gl = gl;
    ...
    ShortBuffer indices = Buffers.allocateNativeShortBuffer(65536 * 3 / 2);
  ...
  private void initShader() {
    ...
    int fragmentShader = loadShader(GL20.GL_FRAGMENT_SHADER, GL11FragmentShader.FRAGMENT_SHADER_SOURCE);
...
//  }
  ...
  public void glPolygonMode(int i, int j) {
    throw new RuntimeException("NYI GL11.glPolygonMode()");
  }
...
//      checkError("enableClientState normalArr");
    ...
    case GL11.GL_TEXTURE_COORD_ARRAY:
      ...
      break;
    default:
      PlayN.log().warn("unsupported / unrecognized client state " + i);
    }
  }
  ...
  public final void glDisableClientState(int i) {
    ...
    case GL11.GL_TEXTURE_COORD_ARRAY:
      ...
      break;
    default:
      PlayN.log().warn("unsupported / unrecogized client state name: " + 
...
//    logFirst("Unsupported state for drawArrays: " + unsupportedState.toString());
  ...
  public void glDeleteTextures(int n, int[] textures, int offset) {
    gl.glDeleteTextures(n, IntBuffer.wrap(textures, offset, n));
//    checkError("glDeleteTextures");
  ...
  public void glGenTextures(int n, int[] textures, int offset) {
    gl.glGenTextures(n, IntBuffer.wrap(textures, offset, n));
//    checkError("glGenTextures");
  ...
  public void glGetIntegerv(int pname, int[] params, int offset) {
    ...
    case GL11.GL_CLIENT_ACTIVE_TEXTURE:
        ...
        break;
    default:
        throw new RuntimeException("GL11.glGetIntegerv unsupported parameter: "+pname);
    }
  }
  ...
  public void glLightModelfv(int pname, FloatBuffer params) {
    unsupportedState.put("lightModelfv-" + GLDebug.getConstantName(pname), Buffers.toString(params));
  }
  ...
  public void glLoadMatrixf(float[] m, int offset) {
    throw new RuntimeException("GL11 NYI glLoadMatrixf");
  }

  @Override
  public void glLogicOp(int opcode) {
    throw new RuntimeException("GL11 NYI glLogicOp");
  }

  @Override
  public void glMaterialf(int face, int pname, float param) {
    throw new RuntimeException("GL11 NYI glMaterialf");
  }

  @Override
  public void glMaterialfv(int face, int pname, float[] params, int offset) {
    throw new RuntimeException("GL11 NYI glMaterialfv");
  }
  ...
  public void glMultMatrixf(FloatBuffer m) {
    throw new RuntimeException("GL11 NYI glMultMatrixf");
  }
  ...
  public void glNormal3f(float nx, float ny, float nz) {
    logFirst("GL11 NYI glNormal3f");
  }

  @Override
  public void glNormalPointer(int type, int stride, Buffer buf) {
    gl.glVertexAttribPointer(ARRAY_NORMAL, 3, type, false, stride, buf);
  }

  @Override
  public void glPointSize(float size) {
    throw new RuntimeException("GL11 NYI glPointSize");
  }

  @Override
  public void glTexEnvf(int target, int pname, float param) {
    throw new RuntimeException("GL11 NYI glTexEnvf");
  }

  @Override
  public void glTexEnvfv(int target, int pname, float[] params, int offset) {
    throw new RuntimeException("GL11 glTexEnvfv NYI");
  }
  ...
  public void glClipPlanef(int plane, float[] equation, int offset) {
    throw new RuntimeException("GL11 glClipPlanef NYI");
  }
  ...
  public void glGetClipPlanef(int pname, float[] eqn, int offset) {
    throw new RuntimeException("GL11 glGetClipPlanef NYI");
  }
  ...
  public void glGetFloatv(int pname, float[] params, int offset) {
    gl.glGetFloatv(pname, FloatBuffer.wrap(params, offset, params.length - offset));
  }

  @Override
  public void glGetLightfv(int light, int pname, float[] params, int offset) {
    throw new RuntimeException("GL11 glGetLightfv NYI");
  }
  ...
  public void glGetMaterialfv(int face, int pname, float[] params, int offset) {
    throw new RuntimeException("GL11 glGetMaterialfv NYI");
  }
  ...
  public void glGetTexParameterfv(int target, int pname, float[] params,
      int offset) {
    gl.glGetTexParameterfv(target, pname, FloatBuffer.wrap(params, offset, 
        params.length - offset));
  }

  @Override
  public void glPointParameterf(int pname, float param) {
    throw new RuntimeException("GL11 glPointParameterf NYI");
  }

  @Override
  public void glPointParameterfv(int pname, float[] params, int offset) {
    throw new RuntimeException("GL11 glPointParameterfv NYI");
  }
  ...
  public void glTexParameterfv(int target, int pname, float[] params, int offset) {
    throw new RuntimeException("GL11 glTexParameterfv NYI");
  }

  @Override
  public void glColor4ub(byte red, byte green, byte blue, byte alpha) {
    throw new RuntimeException("GL11 glColor4ub NYI");
  }

  @Override
  public void glDeleteBuffers(int n, int[] buffers, int offset) {
    if (tmpIntBuffer.capacity() < n) {
      tmpIntBuffer = Buffers.allocateNativeIntBuffer(n * 3 / 2);
    }
  ...
  public void glGetBooleanv(int pname, boolean[] params, int offset) {
    throw new RuntimeException("GL11 glGetBooleanv NYI");
  }
  ...
  public void glGetBufferParameteriv(int target, int pname, int[] params,
      int offset) {
    throw new RuntimeException("GL11 glGetBufferParameteriv NYI");
  }

  @Override
  public void glGetPointerv(int pname, Buffer[] params) {
    throw new RuntimeException("GL11 glGetPointerv NYI");
  }

  @Override
  public void glGetTexEnviv(int env, int pname, int[] params, int offset) {
    throw new RuntimeException("GL11 glGetTexEnviv NYI");
  }
  ...
  public void glGetTexParameteriv(int target, int pname, int[] params,
      int offset) {
    throw new RuntimeException("GL11 glGetTexParameteriv NYI");
  }

  @Override
  public void glTexEnviv(int target, int pname, int[] params, int offset) {
    throw new RuntimeException("GL11 glTexEnviv NYI");
  }
  ...
  public void glTexParameteriv(int target, int pname, int[] params, int offset) {
    throw new RuntimeException("GL11 glTexParameteriv NYI");
  }

  @Override
  public void glPointSizePointerOES(int type, int stride, Buffer pointer) {
    throw new RuntimeException("GL11 glPointSizePointerOES NYI");
  }
...
//  }
  ...
  public void glGenBuffers(int n, int[] buffers, int offset) {
    IntBuffer intBuffer = Buffers.allocateNativeIntBuffer(n);
